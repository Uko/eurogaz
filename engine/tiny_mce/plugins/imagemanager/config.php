<?php
	...
	$mcImageManagerConfig['general.language'] = "uk"; // en, sv
	...
	$mcImageManagerConfig['filesystem.rootpath'] = '../../../catalogue/realSizeImages'; // absolute or relative from this script path, required.
	...
	$mcImageManagerConfig['authenticator'] = "";	// <-- disabled authentification
